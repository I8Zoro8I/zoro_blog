...
![img](https://www.runoob.com/wp-content/uploads/2025/12/429d80de-a480-44ed-8a30-cd31ca579596.png)
...
![img](https://www.runoob.com/wp-content/uploads/2025/12/cb9a6824-3360-47c5-952e-a94202d3cf37-scaled.png)
...
```mermaid
graph TD
    A[开始：拥有高维数据集] --> B{主要目标是什么?}
    
    B -- 为后续模型训练预处理 --> C{数据结构如何?}
    B -- 数据可视化 --> D[选择 t-SNE 或 UMAP]
    
    C -- 线性/近似线性 --> E[选择 PCA]
    C -- 复杂非线性 --> F[选择 核PCA 或 流形学习算法]
    
    E --> G[输出：降维后的特征，用于模型输入]
    F --> G
    D --> H[输出：2维/3维可视化图]
```

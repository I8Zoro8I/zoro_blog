...
- 基本的机器学习算法：线性回归、支持向量机(SVM)、[最近邻居](https://zhida.zhihu.com/search?content_id=5707132&content_type=Article&match_order=1&q=最近邻居&zhida_source=entity)(KNN)、逻辑回归、[决策树](https://zhida.zhihu.com/search?content_id=5707132&content_type=Article&match_order=1&q=决策树&zhida_source=entity)、k平均、随机森林、[朴素贝叶斯](https://zhida.zhihu.com/search?content_id=5707132&content_type=Article&match_order=1&q=朴素贝叶斯&zhida_source=entity)、降维、梯度增强
- 公式、图示、案例

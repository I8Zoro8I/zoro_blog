...
![从提示词、RAG、微调、续训到智能体的方案诊断关系图](https://didilili.github.io/ai-agents-from-zero/images/1-3/1-3-1-1-1.png)
...
这和 [02 提示词工程基础](https://i8zoro8i.github.io/zoro_blog/column/AIAgent/01-大模型基础能力构建/02-提示词工程基础) 的区别也很重要：

- **提示词工程**主要依赖你提前写好的 Prompt。
- **RAG**主要依赖系统在提问时实时检索到的外部资料。

![RAG 的基本流程：先检索外部资料，再把结果与问题一起交给大模型生成答案](https://didilili.github.io/ai-agents-from-zero/images/1-3/1-3-2-1-1.png)
...
- [04RAG搭建企业私有&个人知识库](https://i8zoro8i.github.io/zoro_blog/column/AIAgent/01-大模型基础能力构建/04-RAG搭建企业私有&个人知识库) 会从平台角度带你搭建知识库。
- [RAG检索增强生成](https://i8zoro8i.github.io/zoro_blog/column/AIAgent/03-大模型核心开放框架/11-RAG检索增强生成) 会从 LangChain 代码角度带你拆开 RAG 的技术链路。
...
> **你可能会问：** 微调是不是把企业资料“灌进模型里”？ 更贴切的说法是：微调更擅长让模型“按你想要的方式做事”，而不是“记住所有最新资料”。知识经常变化的场景，优先考虑 RAG；风格、格式、任务习惯长期不稳的场景，再考虑微调。
...
这些方法你在入门阶段不必死记公式，但要建立一个工程认知： **今天大多数团队如果自己做微调，优先考虑的通常不是全参，而是 LoRA / QLoRA 这类 PEFT 路线。**
...
所以微调前后都要问自己： **我到底是在解决一个长期、稳定、可评测的行为问题，还是只是暂时觉得 Prompt 写得不够顺手？**
...
![RAG、微调等方案在“补知识”和“改行为”上的分工对比示意图](https://didilili.github.io/ai-agents-from-zero/images/1-3/1-3-3-6-1.png)
...
![典型 LLM Agent 架构：模型、记忆、工具、规划和行动执行协同工作](https://didilili.github.io/ai-agents-from-zero/images/1-3/1-3-5-1-1.jpg)
...
在本仓库里，智能体这条主线后续会继续展开：[基于 Coze&Dify 平台的智能体开发](https://i8zoro8i.github.io/zoro_blog/column/AIAgent/02-企业低代码平台开发与项目实战/01-基于Coze&Dify平台的智能体开发)、[MCP模型上下文协议](https://i8zoro8i.github.io/zoro_blog/column/AIAgent/03-大模型核心开放框架/12-MCP模型上下文协议)、[Agent智能体](https://i8zoro8i.github.io/zoro_blog/column/AIAgent/03-大模型核心开放框架/13-Agent智能体)、[LangGraph概述与快速入门](https://i8zoro8i.github.io/zoro_blog/column/AIAgent/03-大模型核心开放框架/14-LangGraph概述与快速入门)
...
![Function Calling 的基本流程：模型决定工具和参数，程序负责真正执行](https://didilili.github.io/ai-agents-from-zero/images/1-3/1-3-5-3-1.jpg)

![Function Calling 在实际接口调用中的工具声明与参数返回示意图](https://didilili.github.io/ai-agents-from-zero/images/1-3/1-3-5-3-2.jpg)
...
![MCP 像 AI 世界的 USB-C 接口，用统一协议暴露工具、资源和提示模板](https://didilili.github.io/ai-agents-from-zero/images/1-3/1-3-5-3-3.jpg)
...
![MCP 的调用流程：主机、客户端和服务器之间如何完成能力发现与调用](https://didilili.github.io/ai-agents-from-zero/images/1-3/1-3-5-3-4.jpg)
...
![工作流更强调固定步骤、可控执行和明确顺序的流程编排方式](https://didilili.github.io/ai-agents-from-zero/images/1-3/1-3-5-5-1.jpg)
...
**建议下一步：** 建议按你最关心的能力线继续往下走：想把 RAG 落到代码里，就看 [RAG 检索增强生成](https://i8zoro8i.github.io/zoro_blog/column/AIAgent/03-大模型核心开放框架/11-RAG检索增强生成)；想理解工具接入和协议层，就看 [MCP 模型上下文协议](https://i8zoro8i.github.io/zoro_blog/column/AIAgent/03-大模型核心开放框架/12-MCP模型上下文协议)；想理解多步决策与执行，就看 [Agent 智能体](https://i8zoro8i.github.io/zoro_blog/column/AIAgent/03-大模型核心开放框架/13-Agent智能体)。

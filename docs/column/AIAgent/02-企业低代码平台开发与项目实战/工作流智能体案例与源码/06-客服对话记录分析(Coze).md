...
- **批处理链路**：对每条 `{id, msg}` 依次执行——代码解析当前条 → 大模型「问题分类」（product/content/experience 等标签）→ 大模型「内容总结」（30 字内）→ 大模型「情感分析」（rank + reason）→ 代码_1 封装为统一 output 结构；批处理输出即分析结果数组。
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-2-1-1.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-2-1-2.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-2-1-3.png)

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-2-1-4.png)

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-2-1-5.png)
...
> [https://p9-bot-workflow-sign.byteimg.com/tos-cn-i-mdko3gqilj/2ce6e82b4e184b088a01a7711f94afed.xlsx~tplv-mdko3gqilj-image.image?rk3s=81d4c505&x-expires=1794450789&x-signature=Tv8mNaiBKAeogdkGVbTweoKz0Q4%3D&x-wf-file_name=%E5%AE%A2%E6%9C%8D%E5%AF%B9%E8%AF%9D%E8%AE%B0%E5%BD%95.xlsx](https://p9-bot-workflow-sign.byteimg.com/tos-cn-i-mdko3gqilj/2ce6e82b4e184b088a01a7711f94afed.xlsx~tplv-mdko3gqilj-image.image?rk3s=81d4c505&x-expires=1794450789&x-signature=Tv8mNaiBKAeogdkGVbTweoKz0Q4%3D&x-wf-file_name=客服对话记录.xlsx)

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-2-1-6.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-2-1-7.png)

#### 2.1.3 代码

##### 1.配置

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-2-1-8.png)

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-2-1-9.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-2-1-10.png)

#### 2.1.4 结束

##### 1.配置

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-2-1-11.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-2-2-1.png)

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-2-2-2.png)

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-2-2-3.png)

#### 2.2.3 输出

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-2-2-4.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-1.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-2.png)

#### 3.1.2 excel_preprocess

##### 1.配置

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-3.png)

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-4.png)

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-5.png)

##### 2.测试

###### 输入

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-6.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-7.png)

#### 3.1.3 批处理

##### 1.配置

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-8.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-9.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-10.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-11.png)

###### 2.问题分类

① 配置

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-12.png)

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-13.png)

系统提示词

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-14.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-15.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-16.png)

输出

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-17.png)

###### 3.内容总结

① 配置

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-18.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-19.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-20.png)

输出

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-21.png)

###### 4.情感分析

① 配置

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-22.png)

系统提示词

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-23.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-24.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-25.png)

输出

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-26.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-27.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-28.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-29.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-30.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-31.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-32.png)

#### 3.1.4 输出

##### 1.配置

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-1-33.png)

### 3.2 整体运行测试

#### 3.2.1 输入

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-2-1.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-2-2.png)

#### 3.2.3 调试

运行完成后点击**运行完成**右侧的三角符号可以查看单节点运行的详细信息，批处理内部节点可以看到每次循环的具体信息，数字表示对应的循环轮次，点击数字可以查看对应轮次的详细信息。

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-2-3.png)

调试

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-3-2-4.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-4-1-1.png)

### 4.2 文件上传组件配置

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-4-2-1.png)

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-4-2-2.png)

组件状态配置

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-4-2-3.png)

表达式为`{{message_process.loading}}`，表示工作流`message_process`正在运行，上图中的表示该工作流正在运行时当前组件展示位禁用并加载状态。

### 4.3 文本组件配置

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-4-3-1.png)

### 4.4 文本输入组件配置

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-4-4-1.png)

### 4.5 按钮组件配置

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-4-5-1.png)

事件配置

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-4-5-2.png)
...
![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-4-6-1.png)

点击**结构**标签可以看到所有的组件结构，在 List1 标签下选中 Listitem1 标签，然后添加的组件都是归属于列表元素的子组件

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-4-6-2.png)

### 4.7 调试

![客服对话记录分析案例操作截图](https://didilili.github.io/ai-agents-from-zero/images/3.6/3.6-4-7-1.png)

...
# Docker 快速入门与 Dify 部署排障

已经带你在 Windows 上跑过 Coze Studio、Dify、Coze Loop，上一章会继续讲企业级大模型部署。本章回头补 Docker 这层基础。后面排查 Dify、迁移服务、升级版本时，经常都要回到 Docker 层看状态、日志和数据挂载。
...
![Docker 与虚拟机在架构层面的区别](https://didilili.github.io/ai-agents-from-zero/images/8/8-1-3-1.png)
...
![Docker 客户端、Docker Daemon 与 Registry 的关系](https://didilili.github.io/ai-agents-from-zero/images/8/8-1-4-1.png)
...
![在任务管理器中确认 CPU 虚拟化已启用](https://didilili.github.io/ai-agents-from-zero/images/8/8-2-2-1.png)

WSL 2 相关功能可以在 Windows 功能里勾选。不同 Windows 版本的显示文字可能略有差异，重点是启用 Virtual Machine Platform 和 WSL：

![在 Windows 功能中启用虚拟机平台和适用于 Linux 的 Windows 子系统](https://didilili.github.io/ai-agents-from-zero/images/8/8-2-2-2.png)
...
![Docker Desktop 官方下载页面](https://didilili.github.io/ai-agents-from-zero/images/8/8-2-3-1.png)

### 2.4 安装并启动 Docker Desktop

双击安装包，按提示完成安装即可。安装过程中如果看到 WSL 2、桌面快捷方式等选项，保持默认配置即可。

![Docker Desktop 安装设置界面](https://didilili.github.io/ai-agents-from-zero/images/8/8-2-4-1.png)

安装完成后打开 Docker Desktop，确认状态栏显示 **Running**。

![Docker Desktop 成功启动后的主界面](https://didilili.github.io/ai-agents-from-zero/images/8/8-2-4-2.png)
...
![使用 docker images 查看本地 MySQL 镜像](https://didilili.github.io/ai-agents-from-zero/images/8/8-2-6-1.png)
...
![使用 docker ps 查看正在运行的 MySQL 容器](https://didilili.github.io/ai-agents-from-zero/images/8/8-2-6-2.png)
...
![本机 Python 脚本成功连接 Docker 中的 MySQL](https://didilili.github.io/ai-agents-from-zero/images/8/8-2-7-1.png)
...
![docker ps 输出中 IMAGE 列与 NAMES 列的区别](https://didilili.github.io/ai-agents-from-zero/images/8/8-2-8-1.png)
...
![Docker Desktop 中的 Containers 列表](https://didilili.github.io/ai-agents-from-zero/images/8/8-2-8-2.png)

![Docker Desktop 中的 Images 列表](https://didilili.github.io/ai-agents-from-zero/images/8/8-2-8-3.png)
...
本地学习阶段通常用 Windows + Docker Desktop；正式上服务器时，更常见的是 Ubuntu + Docker Engine。上一章的云服务器部署、后面的电商问数和深度研搜项目，都会先遇到同一个前提：服务器上要有可用的 Docker 和 Compose。
...
![bind mount 中宿主机路径和容器路径的对应关系](https://didilili.github.io/ai-agents-from-zero/images/8/8-4-2-1.png)
...
如果安装 Dify 卡在拉镜像，优先回到本节；如果容器已经启动但页面报错，再进入第 6 部分看应用日志。这样能避免把网络问题误判成 Dify 配置问题。

如果你使用的是 Docker Desktop，通常可以在设置中找到 Docker Engine 的配置区域，然后为 `registry-mirrors` 增加镜像地址。Ubuntu 服务器上的配置方式见第 2.10 小节。

![Docker Desktop 的 Docker Engine 配置界面与 registry-mirrors 示例](https://didilili.github.io/ai-agents-from-zero/images/8/8-4-4-1.png)

镜像源可参考 GitHub 上的汇总项目：dongyubin/DockerHub 国内镜像加速列表。
...
![使用 docker images 确认需要离线迁移的镜像](https://didilili.github.io/ai-agents-from-zero/images/8/8-4-5-1.png)
...
![离线导入镜像后使用 Compose 启动并验证服务](https://didilili.github.io/ai-agents-from-zero/images/8/8-4-5-2.png)
...
<svg id="mermaid-svg-0" width="100%" xmlns="http://www.w3.org/2000/svg" style="max-width: 642.914px; transform: translate(0px, 0px) scale(1); transform-origin: 0px 0px;" viewBox="-8 -8 642.9140625 504" role="graphics-document document" aria-roledescription="flowchart-v2"><g><marker id="mermaid-svg-0_flowchart-pointEnd" class="marker flowchart" viewBox="0 0 10 10" refX="6" refY="5" markerUnits="userSpaceOnUse" markerWidth="12" markerHeight="12" orient="auto"><path d="M 0 0 L 10 5 L 0 10 z" class="arrowMarkerPath" style="stroke-width: 1; stroke-dasharray: 1, 0;"></path></marker><marker id="mermaid-svg-0_flowchart-pointStart" class="marker flowchart" viewBox="0 0 10 10" refX="4.5" refY="5" markerUnits="userSpaceOnUse" markerWidth="12" markerHeight="12" orient="auto"><path d="M 0 5 L 10 10 L 10 0 z" class="arrowMarkerPath" style="stroke-width: 1; stroke-dasharray: 1, 0;"></path></marker><marker id="mermaid-svg-0_flowchart-circleEnd" class="marker flowchart" viewBox="0 0 10 10" refX="11" refY="5" markerUnits="userSpaceOnUse" markerWidth="11" markerHeight="11" orient="auto"><circle cx="5" cy="5" r="5" class="arrowMarkerPath" style="stroke-width: 1; stroke-dasharray: 1, 0;"></circle></marker><marker id="mermaid-svg-0_flowchart-circleStart" class="marker flowchart" viewBox="0 0 10 10" refX="-1" refY="5" markerUnits="userSpaceOnUse" markerWidth="11" markerHeight="11" orient="auto"><circle cx="5" cy="5" r="5" class="arrowMarkerPath" style="stroke-width: 1; stroke-dasharray: 1, 0;"></circle></marker><marker id="mermaid-svg-0_flowchart-crossEnd" class="marker cross flowchart" viewBox="0 0 11 11" refX="12" refY="5.2" markerUnits="userSpaceOnUse" markerWidth="11" markerHeight="11" orient="auto"><path d="M 1,1 l 9,9 M 10,1 l -9,9" class="arrowMarkerPath" style="stroke-width: 2; stroke-dasharray: 1, 0;"></path></marker><marker id="mermaid-svg-0_flowchart-crossStart" class="marker cross flowchart" viewBox="0 0 11 11" refX="-1" refY="5.2" markerUnits="userSpaceOnUse" markerWidth="11" markerHeight="11" orient="auto"><path d="M 1,1 l 9,9 M 10,1 l -9,9" class="arrowMarkerPath" style="stroke-width: 2; stroke-dasharray: 1, 0;"></path></marker><g class="root"><g class="clusters"></g><g class="edgePaths"><path d="M72.602,239.75L76.768,239.75C80.935,239.75,89.268,239.75,99.262,239.75C109.255,239.75,120.909,239.75,126.736,239.75L132.563,239.75" id="L-U-N-0" class="edge-thickness-normal edge-pattern-solid flowchart-link LS-U LE-N" style="fill: none; --darkreader-inline-fill: none;" marker-end="url(#mermaid-svg-0_flowchart-pointEnd)" data-darkreader-inline-fill=""></path><path d="M197.389,265.75L206.676,276.708C215.963,287.667,234.536,309.583,247.106,320.542C259.676,331.5,266.243,331.5,269.526,331.5L272.809,331.5" id="L-N-W-0" class="edge-thickness-normal edge-pattern-solid flowchart-link LS-N LE-W" style="fill: none; --darkreader-inline-fill: none;" marker-end="url(#mermaid-svg-0_flowchart-pointEnd)" data-darkreader-inline-fill=""></path><path d="M202.043,213.75L210.554,205.458C219.065,197.167,236.087,180.583,249.481,172.292C262.875,164,272.641,164,277.524,164L282.407,164" id="L-N-A-0" class="edge-thickness-normal edge-pattern-solid flowchart-link LS-N LE-A" style="fill: none; --darkreader-inline-fill: none;" marker-end="url(#mermaid-svg-0_flowchart-pointEnd)" data-darkreader-inline-fill=""></path><path d="M347.665,191.5L358.739,213.167C369.813,234.833,391.961,278.167,418.029,316.1C444.097,354.034,474.085,386.569,489.078,402.836L504.072,419.103" id="L-A-P-0" class="edge-thickness-normal edge-pattern-solid flowchart-link LS-A LE-P" style="fill: none; --darkreader-inline-fill: none;" marker-end="url(#mermaid-svg-0_flowchart-pointEnd)" data-darkreader-inline-fill=""></path><path d="M356.912,191.5L366.445,202.75C375.978,214,395.044,236.5,417.379,257.064C439.714,277.627,465.319,296.255,478.122,305.568L490.925,314.882" id="L-A-R-0" class="edge-thickness-normal edge-pattern-solid flowchart-link LS-A LE-R" style="fill: none; --darkreader-inline-fill: none;" marker-end="url(#mermaid-svg-0_flowchart-pointEnd)" data-darkreader-inline-fill=""></path><path d="M379.512,182.104L385.278,184.379C391.044,186.653,402.577,191.201,418.08,197.017C433.583,202.834,453.057,209.917,462.794,213.459L472.531,217.001" id="L-A-V-0" class="edge-thickness-normal edge-pattern-solid flowchart-link LS-A LE-V" style="fill: none; --darkreader-inline-fill: none;" marker-end="url(#mermaid-svg-0_flowchart-pointEnd)" data-darkreader-inline-fill=""></path><path d="M379.512,146.038L385.278,143.782C391.044,141.525,402.577,137.013,419.626,134.756C436.676,132.5,459.243,132.5,470.526,132.5L481.809,132.5" id="L-A-S-0" class="edge-thickness-normal edge-pattern-solid flowchart-link LS-A LE-S" style="fill: none; --darkreader-inline-fill: none;" marker-end="url(#mermaid-svg-0_flowchart-pointEnd)" data-darkreader-inline-fill=""></path><path d="M349.827,136.5L360.541,118.333C371.255,100.167,392.682,63.833,412.016,45.667C431.351,27.5,448.592,27.5,457.212,27.5L465.833,27.5" id="L-A-PD-0" class="edge-thickness-normal edge-pattern-solid flowchart-link LS-A LE-PD" style="fill: none; --darkreader-inline-fill: none;" marker-end="url(#mermaid-svg-0_flowchart-pointEnd)" data-darkreader-inline-fill=""></path><path d="M379.512,471.904L385.278,473.337C391.044,474.77,402.577,477.635,411.653,478.232C420.73,478.83,427.35,477.159,430.66,476.324L433.97,475.489" id="L-WK-P-0" class="edge-thickness-normal edge-pattern-solid flowchart-link LS-WK LE-P" style="fill: none; --darkreader-inline-fill: none;" marker-end="url(#mermaid-svg-0_flowchart-pointEnd)" data-darkreader-inline-fill=""></path><path d="M379.512,436.266L385.278,433.222C391.044,430.177,402.577,424.089,419.889,414.004C437.201,403.92,460.294,389.839,471.84,382.799L483.386,375.759" id="L-WK-R-0" class="edge-thickness-normal edge-pattern-solid flowchart-link LS-WK LE-R" style="fill: none; --darkreader-inline-fill: none;" marker-end="url(#mermaid-svg-0_flowchart-pointEnd)" data-darkreader-inline-fill=""></path><path d="M354.543,433L364.471,419.958C374.399,406.917,394.254,380.833,418.401,353.949C442.548,327.066,470.986,299.381,485.205,285.539L499.424,271.697" id="L-WK-V-0" class="edge-thickness-normal edge-pattern-solid flowchart-link LS-WK LE-V" style="fill: none; --darkreader-inline-fill: none;" marker-end="url(#mermaid-svg-0_flowchart-pointEnd)" data-darkreader-inline-fill=""></path><path d="M228.109,460.5L232.276,460.5C236.443,460.5,244.776,460.5,253.826,460.5C262.875,460.5,272.641,460.5,277.524,460.5L282.407,460.5" id="L-WB-WK-0" class="edge-thickness-normal edge-pattern-solid flowchart-link LS-WB LE-WK" style="fill: none; --darkreader-inline-fill: none;" marker-end="url(#mermaid-svg-0_flowchart-pointEnd)" data-darkreader-inline-fill=""></path></g><g class="edgeLabels"><g class="edgeLabel"><g class="label" transform="translate(0, 0)"><foreignObject width="0" height="0"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="edgeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182); background-color: rgb(46, 49, 50); text-align: center;"></span></div></foreignObject></g></g><g class="edgeLabel"><g class="label" transform="translate(0, 0)"><foreignObject width="0" height="0"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="edgeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182); background-color: rgb(46, 49, 50); text-align: center;"></span></div></foreignObject></g></g><g class="edgeLabel"><g class="label" transform="translate(0, 0)"><foreignObject width="0" height="0"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="edgeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182); background-color: rgb(46, 49, 50); text-align: center;"></span></div></foreignObject></g></g><g class="edgeLabel"><g class="label" transform="translate(0, 0)"><foreignObject width="0" height="0"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="edgeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182); background-color: rgb(46, 49, 50); text-align: center;"></span></div></foreignObject></g></g><g class="edgeLabel"><g class="label" transform="translate(0, 0)"><foreignObject width="0" height="0"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="edgeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182); background-color: rgb(46, 49, 50); text-align: center;"></span></div></foreignObject></g></g><g class="edgeLabel"><g class="label" transform="translate(0, 0)"><foreignObject width="0" height="0"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="edgeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182); background-color: rgb(46, 49, 50); text-align: center;"></span></div></foreignObject></g></g><g class="edgeLabel"><g class="label" transform="translate(0, 0)"><foreignObject width="0" height="0"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="edgeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182); background-color: rgb(46, 49, 50); text-align: center;"></span></div></foreignObject></g></g><g class="edgeLabel"><g class="label" transform="translate(0, 0)"><foreignObject width="0" height="0"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="edgeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182); background-color: rgb(46, 49, 50); text-align: center;"></span></div></foreignObject></g></g><g class="edgeLabel"><g class="label" transform="translate(0, 0)"><foreignObject width="0" height="0"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="edgeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182); background-color: rgb(46, 49, 50); text-align: center;"></span></div></foreignObject></g></g><g class="edgeLabel"><g class="label" transform="translate(0, 0)"><foreignObject width="0" height="0"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="edgeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182); background-color: rgb(46, 49, 50); text-align: center;"></span></div></foreignObject></g></g><g class="edgeLabel"><g class="label" transform="translate(0, 0)"><foreignObject width="0" height="0"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="edgeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182); background-color: rgb(46, 49, 50); text-align: center;"></span></div></foreignObject></g></g><g class="edgeLabel"><g class="label" transform="translate(0, 0)"><foreignObject width="0" height="0"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="edgeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182); background-color: rgb(46, 49, 50); text-align: center;"></span></div></foreignObject></g></g></g><g class="nodes"><g class="node default default flowchart-label" id="flowchart-U-0" data-node="true" data-id="U" transform="translate(36.30078125, 239.75)"><rect class="basic label-container" style="" rx="0" ry="0" x="-36.30078125" y="-18.25" width="72.6015625" height="36.5"></rect><g class="label" style="" transform="translate(-28.80078125, -10.75)"><rect></rect><foreignObject width="57.6015625" height="21.5"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="nodeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182);">浏览器</span></div></foreignObject></g></g><g class="node default default flowchart-label" id="flowchart-N-1" data-node="true" data-id="N" transform="translate(175.35546875, 239.75)"><rect class="basic label-container" style="" rx="0" ry="0" x="-37.4921875" y="-26" width="74.984375" height="52"></rect><g class="label" style="" transform="translate(-29.9921875, -18.5)"><rect></rect><foreignObject width="59.984375" height="37"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="nodeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182);">nginx<br style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box;">80 / 443</span></div></foreignObject></g></g><g class="node default default flowchart-label" id="flowchart-W-3" data-node="true" data-id="W" transform="translate(333.609375, 331.5)"><rect class="basic label-container" style="" rx="0" ry="0" x="-55.5" y="-27.5" width="111" height="55"></rect><g class="label" style="" transform="translate(-48, -20)"><rect></rect><foreignObject width="96" height="40"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="nodeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182);">web<br style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box;">控制台页面</span></div></foreignObject></g></g><g class="node default default flowchart-label" id="flowchart-A-5" data-node="true" data-id="A" transform="translate(333.609375, 164)"><rect class="basic label-container" style="" rx="0" ry="0" x="-45.90234375" y="-27.5" width="91.8046875" height="55"></rect><g class="label" style="" transform="translate(-38.40234375, -20)"><rect></rect><foreignObject width="76.8046875" height="40"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="nodeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182);">api<br style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box;">后端接口</span></div></foreignObject></g></g><g class="node default default flowchart-label" id="flowchart-P-7" data-node="true" data-id="P" transform="translate(533.01171875, 450.5)"><rect class="basic label-container" style="" rx="0" ry="0" x="-93.90234375" y="-27.5" width="187.8046875" height="55"></rect><g class="label" style="" transform="translate(-86.40234375, -20)"><rect></rect><foreignObject width="172.8046875" height="40"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="nodeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182);">db_postgres<br style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box;">账号、应用、工作流</span></div></foreignObject></g></g><g class="node default default flowchart-label" id="flowchart-R-9" data-node="true" data-id="R" transform="translate(533.01171875, 345.5)"><rect class="basic label-container" style="" rx="0" ry="0" x="-55.5" y="-27.5" width="111" height="55"></rect><g class="label" style="" transform="translate(-48, -20)"><rect></rect><foreignObject width="96" height="40"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="nodeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182);">redis<br style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box;">缓存、队列</span></div></foreignObject></g></g><g class="node default default flowchart-label" id="flowchart-V-11" data-node="true" data-id="V" transform="translate(533.01171875, 239)"><rect class="basic label-container" style="" rx="0" ry="0" x="-55.5" y="-29" width="111" height="58"></rect><g class="label" style="" transform="translate(-48, -21.5)"><rect></rect><foreignObject width="96" height="43"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="nodeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182);">向量库<br style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box;">知识库检索</span></div></foreignObject></g></g><g class="node default default flowchart-label" id="flowchart-S-13" data-node="true" data-id="S" transform="translate(533.01171875, 132.5)"><rect class="basic label-container" style="" rx="0" ry="0" x="-45.90234375" y="-27.5" width="91.8046875" height="55"></rect><g class="label" style="" transform="translate(-38.40234375, -20)"><rect></rect><foreignObject width="76.8046875" height="40"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="nodeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182);">sandbox<br style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box;">代码节点</span></div></foreignObject></g></g><g class="node default default flowchart-label" id="flowchart-PD-15" data-node="true" data-id="PD" transform="translate(533.01171875, 27.5)"><rect class="basic label-container" style="" rx="0" ry="0" x="-61.87890625" y="-27.5" width="123.7578125" height="55"></rect><g class="label" style="" transform="translate(-54.37890625, -20)"><rect></rect><foreignObject width="108.7578125" height="40"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="nodeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182);">plugin_daemon<br style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box;">插件与工具</span></div></foreignObject></g></g><g class="node default default flowchart-label" id="flowchart-WK-16" data-node="true" data-id="WK" transform="translate(333.609375, 460.5)"><rect class="basic label-container" style="" rx="0" ry="0" x="-45.90234375" y="-27.5" width="91.8046875" height="55"></rect><g class="label" style="" transform="translate(-38.40234375, -20)"><rect></rect><foreignObject width="76.8046875" height="40"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="nodeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182);">worker<br style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box;">后台任务</span></div></foreignObject></g></g><g class="node default default flowchart-label" id="flowchart-WB-22" data-node="true" data-id="WB" transform="translate(175.35546875, 460.5)"><rect class="basic label-container" style="" rx="0" ry="0" x="-52.75390625" y="-27.5" width="105.5078125" height="55"></rect><g class="label" style="" transform="translate(-45.25390625, -20)"><rect></rect><foreignObject width="90.5078125" height="40"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="nodeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182);">worker_beat<br style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box;">定时任务</span></div></foreignObject></g></g></g></g></g></svg>
...
<svg id="mermaid-svg-1" width="100%" xmlns="http://www.w3.org/2000/svg" style="max-width: 300.281px; transform: translate(0px, 0px) scale(1); transform-origin: 0px 0px;" viewBox="-8 -8 300.28125 571.5" role="graphics-document document" aria-roledescription="flowchart-v2"><g><marker id="mermaid-svg-1_flowchart-pointEnd" class="marker flowchart" viewBox="0 0 10 10" refX="6" refY="5" markerUnits="userSpaceOnUse" markerWidth="12" markerHeight="12" orient="auto"><path d="M 0 0 L 10 5 L 0 10 z" class="arrowMarkerPath" style="stroke-width: 1; stroke-dasharray: 1, 0;"></path></marker><marker id="mermaid-svg-1_flowchart-pointStart" class="marker flowchart" viewBox="0 0 10 10" refX="4.5" refY="5" markerUnits="userSpaceOnUse" markerWidth="12" markerHeight="12" orient="auto"><path d="M 0 5 L 10 10 L 10 0 z" class="arrowMarkerPath" style="stroke-width: 1; stroke-dasharray: 1, 0;"></path></marker><marker id="mermaid-svg-1_flowchart-circleEnd" class="marker flowchart" viewBox="0 0 10 10" refX="11" refY="5" markerUnits="userSpaceOnUse" markerWidth="11" markerHeight="11" orient="auto"><circle cx="5" cy="5" r="5" class="arrowMarkerPath" style="stroke-width: 1; stroke-dasharray: 1, 0;"></circle></marker><marker id="mermaid-svg-1_flowchart-circleStart" class="marker flowchart" viewBox="0 0 10 10" refX="-1" refY="5" markerUnits="userSpaceOnUse" markerWidth="11" markerHeight="11" orient="auto"><circle cx="5" cy="5" r="5" class="arrowMarkerPath" style="stroke-width: 1; stroke-dasharray: 1, 0;"></circle></marker><marker id="mermaid-svg-1_flowchart-crossEnd" class="marker cross flowchart" viewBox="0 0 11 11" refX="12" refY="5.2" markerUnits="userSpaceOnUse" markerWidth="11" markerHeight="11" orient="auto"><path d="M 1,1 l 9,9 M 10,1 l -9,9" class="arrowMarkerPath" style="stroke-width: 2; stroke-dasharray: 1, 0;"></path></marker><marker id="mermaid-svg-1_flowchart-crossStart" class="marker cross flowchart" viewBox="0 0 11 11" refX="-1" refY="5.2" markerUnits="userSpaceOnUse" markerWidth="11" markerHeight="11" orient="auto"><path d="M 1,1 l 9,9 M 10,1 l -9,9" class="arrowMarkerPath" style="stroke-width: 2; stroke-dasharray: 1, 0;"></path></marker><g class="root"><g class="clusters"></g><g class="edgePaths"><path d="M142.141,36.5L142.141,40.667C142.141,44.833,142.141,53.167,142.141,60.617C142.141,68.067,142.141,74.633,142.141,77.917L142.141,81.2" id="L-A-B-0" class="edge-thickness-normal edge-pattern-solid flowchart-link LS-A LE-B" style="fill: none; --darkreader-inline-fill: none;" marker-end="url(#mermaid-svg-1_flowchart-pointEnd)" data-darkreader-inline-fill=""></path><path d="M142.141,123L142.141,127.167C142.141,131.333,142.141,139.667,142.141,147.117C142.141,154.567,142.141,161.133,142.141,164.417L142.141,167.7" id="L-B-C-0" class="edge-thickness-normal edge-pattern-solid flowchart-link LS-B LE-C" style="fill: none; --darkreader-inline-fill: none;" marker-end="url(#mermaid-svg-1_flowchart-pointEnd)" data-darkreader-inline-fill=""></path><path d="M142.141,209.5L142.141,213.667C142.141,217.833,142.141,226.167,142.141,233.617C142.141,241.067,142.141,247.633,142.141,250.917L142.141,254.2" id="L-C-D-0" class="edge-thickness-normal edge-pattern-solid flowchart-link LS-C LE-D" style="fill: none; --darkreader-inline-fill: none;" marker-end="url(#mermaid-svg-1_flowchart-pointEnd)" data-darkreader-inline-fill=""></path><path d="M142.141,296L142.141,300.167C142.141,304.333,142.141,312.667,142.141,320.117C142.141,327.567,142.141,334.133,142.141,337.417L142.141,340.7" id="L-D-E-0" class="edge-thickness-normal edge-pattern-solid flowchart-link LS-D LE-E" style="fill: none; --darkreader-inline-fill: none;" marker-end="url(#mermaid-svg-1_flowchart-pointEnd)" data-darkreader-inline-fill=""></path><path d="M142.141,382.5L142.141,386.667C142.141,390.833,142.141,399.167,142.141,406.617C142.141,414.067,142.141,420.633,142.141,423.917L142.141,427.2" id="L-E-F-0" class="edge-thickness-normal edge-pattern-solid flowchart-link LS-E LE-F" style="fill: none; --darkreader-inline-fill: none;" marker-end="url(#mermaid-svg-1_flowchart-pointEnd)" data-darkreader-inline-fill=""></path><path d="M142.141,469L142.141,473.167C142.141,477.333,142.141,485.667,142.141,493.117C142.141,500.567,142.141,507.133,142.141,510.417L142.141,513.7" id="L-F-G-0" class="edge-thickness-normal edge-pattern-solid flowchart-link LS-F LE-G" style="fill: none; --darkreader-inline-fill: none;" marker-end="url(#mermaid-svg-1_flowchart-pointEnd)" data-darkreader-inline-fill=""></path></g><g class="edgeLabels"><g class="edgeLabel"><g class="label" transform="translate(0, 0)"><foreignObject width="0" height="0"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="edgeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182); background-color: rgb(46, 49, 50); text-align: center;"></span></div></foreignObject></g></g><g class="edgeLabel"><g class="label" transform="translate(0, 0)"><foreignObject width="0" height="0"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="edgeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182); background-color: rgb(46, 49, 50); text-align: center;"></span></div></foreignObject></g></g><g class="edgeLabel"><g class="label" transform="translate(0, 0)"><foreignObject width="0" height="0"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="edgeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182); background-color: rgb(46, 49, 50); text-align: center;"></span></div></foreignObject></g></g><g class="edgeLabel"><g class="label" transform="translate(0, 0)"><foreignObject width="0" height="0"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="edgeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182); background-color: rgb(46, 49, 50); text-align: center;"></span></div></foreignObject></g></g><g class="edgeLabel"><g class="label" transform="translate(0, 0)"><foreignObject width="0" height="0"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="edgeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182); background-color: rgb(46, 49, 50); text-align: center;"></span></div></foreignObject></g></g><g class="edgeLabel"><g class="label" transform="translate(0, 0)"><foreignObject width="0" height="0"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="edgeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182); background-color: rgb(46, 49, 50); text-align: center;"></span></div></foreignObject></g></g></g><g class="nodes"><g class="node default default flowchart-label" id="flowchart-A-24" data-node="true" data-id="A" transform="translate(142.140625, 18.25)"><rect class="basic label-container" style="" rx="0" ry="0" x="-72.98046875" y="-18.25" width="145.9609375" height="36.5"></rect><g class="label" style="" transform="translate(-65.48046875, -10.75)"><rect></rect><foreignObject width="130.9609375" height="21.5"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="nodeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182);">Docker 是否运行</span></div></foreignObject></g></g><g class="node default default flowchart-label" id="flowchart-B-25" data-node="true" data-id="B" transform="translate(142.140625, 104.75)"><rect class="basic label-container" style="" rx="0" ry="0" x="-142.140625" y="-18.25" width="284.28125" height="36.5"></rect><g class="label" style="" transform="translate(-134.640625, -10.75)"><rect></rect><foreignObject width="269.28125" height="21.5"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="nodeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182);">是否在正确 docker 目录执行命令</span></div></foreignObject></g></g><g class="node default default flowchart-label" id="flowchart-C-27" data-node="true" data-id="C" transform="translate(142.140625, 191.25)"><rect class="basic label-container" style="" rx="0" ry="0" x="-125.890625" y="-18.25" width="251.78125" height="36.5"></rect><g class="label" style="" transform="translate(-118.390625, -10.75)"><rect></rect><foreignObject width="236.78125" height="21.5"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="nodeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182);">docker compose ps 看容器状态</span></div></foreignObject></g></g><g class="node default default flowchart-label" id="flowchart-D-29" data-node="true" data-id="D" transform="translate(142.140625, 277.75)"><rect class="basic label-container" style="" rx="0" ry="0" x="-84.30078125" y="-18.25" width="168.6015625" height="36.5"></rect><g class="label" style="" transform="translate(-76.80078125, -10.75)"><rect></rect><foreignObject width="153.6015625" height="21.5"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="nodeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182);">入口端口是否映射</span></div></foreignObject></g></g><g class="node default default flowchart-label" id="flowchart-E-31" data-node="true" data-id="E" transform="translate(142.140625, 364.25)"><rect class="basic label-container" style="" rx="0" ry="0" x="-91.90625" y="-18.25" width="183.8125" height="36.5"></rect><g class="label" style="" transform="translate(-84.40625, -10.75)"><rect></rect><foreignObject width="168.8125" height="21.5"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="nodeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182);">nginx / web / api 日志</span></div></foreignObject></g></g><g class="node default default flowchart-label" id="flowchart-F-33" data-node="true" data-id="F" transform="translate(142.140625, 450.75)"><rect class="basic label-container" style="" rx="0" ry="0" x="-99.89453125" y="-18.25" width="199.7890625" height="36.5"></rect><g class="label" style="" transform="translate(-92.39453125, -10.75)"><rect></rect><foreignObject width="184.7890625" height="21.5"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="nodeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182);">db / redis / 向量库日志</span></div></foreignObject></g></g><g class="node default default flowchart-label" id="flowchart-G-35" data-node="true" data-id="G" transform="translate(142.140625, 537.25)"><rect class="basic label-container" style="" rx="0" ry="0" x="-92.703125" y="-18.25" width="185.40625" height="36.5"></rect><g class="label" style="" transform="translate(-85.203125, -10.75)"><rect></rect><foreignObject width="170.40625" height="21.5"><div xmlns="http://www.w3.org/1999/xhtml" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; display: inline-block; white-space: nowrap;"><span class="nodeLabel" style="-webkit-font-smoothing: antialiased; -webkit-tap-highlight-color: rgba(221, 220, 217, 0); text-size-adjust: none; box-sizing: border-box; fill: rgb(193, 188, 182); color: rgb(193, 188, 182);">.env 配置和数据挂载</span></div></foreignObject></g></g></g></g></g></svg>
...
![Dify 升级后进入初始化管理员页面的示例](https://didilili.github.io/ai-agents-from-zero/images/8/8-6-4-1.png)

也可能在浏览器里看到安装/初始化入口。出现这种情况时，不要急着重新初始化，先检查旧数据库是否还在：

![Dify 升级后进入安装入口页面的示例](https://didilili.github.io/ai-agents-from-zero/images/8/8-6-4-2.png)
...
![通过 psql 查询 Dify 用户表记录数以判断是否读到旧数据库](https://didilili.github.io/ai-agents-from-zero/images/8/8-6-4-3.png)
...
![使用 docker volume ls 查看 Dify 相关 volume 列表](https://didilili.github.io/ai-agents-from-zero/images/8/8-6-4-4.png)

`docker inspect` 的 Mounts 字段能看到数据库容器实际挂载到了哪里：

![使用 docker inspect 查看 PostgreSQL 容器的 Mounts 挂载信息](https://didilili.github.io/ai-agents-from-zero/images/8/8-6-4-5.png)
...
![在 Mac 本地保存用于 SSH 隧道连接的服务器私钥](https://didilili.github.io/ai-agents-from-zero/images/8/8-6-5-1.png)
...
![建立 SSH 隧道后终端保持连接的状态](https://didilili.github.io/ai-agents-from-zero/images/8/8-6-5-2.png)

Navicat 里不要再勾选 SSH 选项，因为隧道已经由命令行建好了。它只需要连接本机端口：

![Navicat 中通过本机 15432 端口连接 PostgreSQL 的配置](https://didilili.github.io/ai-agents-from-zero/images/8/8-6-5-3.png)
...
![Navicat 成功连接 Dify PostgreSQL 数据库后的表结构视图](https://didilili.github.io/ai-agents-from-zero/images/8/8-6-5-4.png)
...
![执行 docker compose down 后容器和网络被移除的终端输出](https://didilili.github.io/ai-agents-from-zero/images/8/8-7-1-1.png)

可以再看一眼 volume 是否仍然存在：

![docker compose down 后使用 docker volume ls 确认 volume 仍然存在](https://didilili.github.io/ai-agents-from-zero/images/8/8-7-1-2.png)
...
![通过 git clone 拉取 Dify 新版本源码目录的终端示例](https://didilili.github.io/ai-agents-from-zero/images/8/8-7-1-3.png)

把旧版本 `.env` 复制过来，再按新版本 `.env.example` 补齐新增变量。若项目提供同步脚本，可以使用官方推荐脚本；如果没有，就逐项对照新旧 `.env`。

同步脚本或配置对比工具通常会提示哪些变量需要保留、补齐或调整：

![Dify 升级时同步 .env 配置后的终端输出示例](https://didilili.github.io/ai-agents-from-zero/images/8/8-7-1-4.png)

实际改配置时，建议一项一项确认，不要整段盲贴：

![在终端编辑 Dify .env 配置文件的示例](https://didilili.github.io/ai-agents-from-zero/images/8/8-7-1-5.png)
...
![使用 grep 确认 Dify 升级后的关键 .env 变量](https://didilili.github.io/ai-agents-from-zero/images/8/8-7-1-6.png)
...
![执行 docker compose pull 拉取 Dify 服务镜像的输出示例](https://didilili.github.io/ai-agents-from-zero/images/8/8-7-1-7.png)

启动后可以用 `docker ps` 或 `docker compose ps` 查看容器状态：

![Dify 新版本启动后使用 docker ps 查看容器状态](https://didilili.github.io/ai-agents-from-zero/images/8/8-7-1-8.png)
...
![向已初始化数据库导入备份时出现 already exists 重复对象报错](https://didilili.github.io/ai-agents-from-zero/images/8/8-7-1-9.png)
...
![重建 dify 数据库并准备重新导入备份的终端示例](https://didilili.github.io/ai-agents-from-zero/images/8/8-7-1-10.png)

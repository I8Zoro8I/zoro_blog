...
export const llmApplicationCategory = {
  ...
  "children": [
    ...
    },
    {
      ...
      "links": [
        {
          "title": "LangChain概述与架构",
          "url": "/column/AIAgent/03-大模型核心开发框架/01-LangChain概述与架构",
          "visible": true
        },
        {
          "title": "LangChain快速上手与HelloWorld",
      ...
      "links": [
        ...
        },
        {
          ...
          "items": [
            ...
            {
              "title": "接入 LangGraph 与 LangChain",
